...
function getWeather() {
    ...
    document.querySelector("#today-weather-info").style.display = "block";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(weatherType =="01d" || weatherType == "01n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-day-sunny"></i>`;
            }
            else if(weatherType =="02d" || weatherType == "02n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-day-cloudy"></i>`;
            }
            else if(weatherType == "03d" || weatherType == "03n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-cloud"></i>`;
            }
            else if(weatherType == "04d" || weatherType == "04n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-cloudy"></i>`;
            }
            else if(weatherType == "09d" || weatherType == "09n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-showers"></i>`;
            }
            else if(weatherType == "10d" || weatherType == "10n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-day-rain"></i>`;
            }
            else if(weatherType == "11d" || weatherType == "11n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-thunderstorm"></i>`;
            }
            else if(weatherType == "13d" || weatherType == "13n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-snow"></i>`;
            }
            else if(weatherType == "50d" || weatherType == "50n"){
                document.querySelector("#cloud-today").innerHTML = `<i class="wi wi-fog"></i>`;
            }          
            document.querySelector("#city-name").innerHTML = `${data.name} , ${data.sys.country}`;
            document.querySelector("#temp-today > span").innerHTML = Math.round(data.main.temp);
            document.querySelector("#description-today").innerHTML = data.weather[0].main;
            document.querySelector("#temp-range-today .min").innerHTML = Math.round(data.main.temp_min);
            document.querySelector("#temp-range-today .max").innerHTML = Math.round(data.main.temp_max);
    ...
    $.ajax({
        ...
        success: function(data){
            document.querySelector("#forecasts-container").style.display = "block";
